...
const EditProject = () => {
  ...
  useEffect(() => {
    // setProjectLoading(true); // Start loading when fetching data
    axiouSecure
      .get(`/get-project/${id}`)
      .then((res) => {
        console.log(res);
      ...
      .finally(() => {
        setProjectLoading(false); // End loading after fetching
      });
  }, [axiouSecure, id]);
      ...
      <div className="bg-white p-4 rounded-md">
        {projectLoading ? (
          <div className="flex justify-center items-center h-64">
            <div
              className="spinner-border animate-spin inline-block w-8 h-8 border-4 border-solid border-primary rounded-full"
              role="status"
            >
